...
def QHDaqiValue():
    try: # Exception handlers in case that non-digit data (that are not convertible to int) get imported.
        ...
        print("\nFailed to write inbound data \'%s\' to serial port. Reason: %s" % (value ,e))
    return value
